...
create_table = "CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY, username text UNIQUE, password text, email text UNIQUE, age INTEGER, location text, option_1 text, option_2 text, option_3 text, option_4 text, family boolean DEFAULT false, gender STRING)"
