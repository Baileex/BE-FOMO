...
from resources.events import EventList, Event, EventPoster, EventByID, PatchLocation, DeleteById, EventByEventID
...
api.add_resource(Business, '/businesses/<string:username>')
...
api.add_resource(EventByEventID, '/events/event/<int:id>')
